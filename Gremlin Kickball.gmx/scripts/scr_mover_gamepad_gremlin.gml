...
var hchince = lengthdir_x(gamepad_axis_value(_n, gp_axislh), direction) * magic_force;
var vchince = lengthdir_y(gamepad_axis_value(_n, gp_axislv), direction) * magic_force;
